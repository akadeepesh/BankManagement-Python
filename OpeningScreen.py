...
def team(d):
    ...
    def team1(e):
        ...
        l2.place(x=490, y=80)
        Label(
            root1, text="Mr. ML\n Meena Sir", bg="grey4", fg="lightgreen", borderwidth=0
        ).place(x=785, y=560)
...
def about(z):
    ...
    f = LabelFrame(
        root1, text="About Our Project", bg="yellow", fg="green", padx=20, pady=20
    )
    f.pack(padx=40, pady=40)
...
def module(m):
    ...
    f = LabelFrame(
        root1,
        text="These Are The Modules We Use",
        bg="yellow",
        fg="green",
        padx=20,
        pady=20,
...
b1 = Button(
    ...
    activeforeground="grey19",
    command=lambda: about(1),
)
